...
Master Training & Benchmark Runner for VARDHAN-v2A (Tri-Branch Multi-Representation RF-Net).
...
def main():
    ...
    # 3. Instantiate DataLoaders (VARDHAN raw waveform loader -> (1, 2048))
    ...
    # 7. Final Test Evaluation using best.pt
